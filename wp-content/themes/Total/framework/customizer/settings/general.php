...
$this->sections['wpex_general_links_buttons'] = array(
	...
	'settings' => array(
		...
		array(
			...
			'inline_css' => array(
				'target' => '.theme-button,input[type="submit"],button,.button',
				'alter' => 'padding',
			),
		),
		array(
			...
			'inline_css' => array(
				'target' => '.theme-button,input[type="submit"],button,#site-navigation .menu-button > a > span.link-inner,.button',
				'alter' => 'border-radius',
			),
		),
		array(
		...
		array(
			...
			'inline_css' => array(
				'target' => '.theme-button:hover,input[type="submit"]:hover,button:hover,#site-navigation .menu-button > a:hover > span.link-inner,.button:hover',
				'alter' => 'background',
			),
		),
		array(
