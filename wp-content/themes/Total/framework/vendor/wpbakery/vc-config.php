...
class WPEX_Visual_Composer_Config {
	...
	public function __construct() {
		...
		require_once WPEX_VCEX_DIR . 'classes/VCEX_Query_Builder.php';
		require_once WPEX_VCEX_DIR . 'vc-autocomplete.php';
		require_once WPEX_VCEX_DIR . 'vcex-loadmore.php';
	...
	public static function hide_vc_buttons_media_library() {
		...
		$hide_types = apply_filters( 'wpex_admin_hide_vc_editor_post_types', array( 'attachment', 'acf', 'wpex_sidebars', 'acf-field-group' ) );
